...
def preprocess_drup_response_matrix(which_gdsc: Set[str]=['GDSC1', 'GDSC2']):

    # TODO
    # gdsc1, gdsc2 = None, None
    # if 'GDSC1' in which_gdsc: 
    #     gdsc1 = pd.read_excel(f'{PATH_TO_GDSC_SCREENING_DATA}{GDSC1_IC50_FILE}', header=0)
