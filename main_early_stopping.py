...
def parse_args():
    ...
    parser.add_argument('--early_stopping_threshold', type=float, default=10,
...
def main():
    ...
    # --- GraphTab model training ---    
        ...
        # ----------------------
#         trainer = create_supervised_trainer(build_model.model, loss_func, optimizer) 
#         early_stopping = EarlyStopping(
#             patience=build_model.early_stopping_threshold,
#             score_function=build_model._score_function,
#             trainer=build_model
#         )
# #         early_stopping.attach(engine, 'early_stopping')
#         build_model.add_event_handler(
